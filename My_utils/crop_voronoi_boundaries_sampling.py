...
"""
My First attemp to crop the voronoi tasselation by means of a sampling over the boundaries of the box volume.
It tourned out slow and un-efficienty respect to the more simple, actual one. Whic implements a simple check over tassell's vertices
"""
