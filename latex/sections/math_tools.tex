...
% In section \ref{ssec:app_mkov}, in Figure \ref{fig:sampling_comparison} is shown a comparison between corresponding section obtained following different sampling methods for the 
